...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Pokant replaced 800 lines of Playwright selectors with a single API call. When the site redesigned, nothing broke. We just kept shipping.",
      name: "Alex Rivera",
      company: "Staff Engineer, DataPipe",
      image: "/testimonial-avatar-1.jpg",
    },
    {
      quote:
        "The explore-to-replay model is brilliant. We pay $0.40 to figure out a new workflow, then $0.02 forever after. Our scraping costs dropped 94% in a month.",
      name: "Priya Mehta",
      company: "Head of Data, ScaleAI",
      image: "/testimonial-avatar-2.jpg",
    },
    {
      quote:
        "We tried Browser Use, Playwright, and three other tools. Pokant is the first one that actually handles auth walls and CAPTCHAs without babysitting.",
      name: "Marcus Chen",
      company: "Founding Engineer, Autonomi",
