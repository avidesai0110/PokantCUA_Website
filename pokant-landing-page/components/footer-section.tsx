      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
            Browser automation that works in production
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2">
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">API</span>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Documentation</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Examples</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Blog</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">API Reference</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Community</span>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Privacy</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">Terms</span>
              <span className="text-[#49423D] text-sm font-normal leading-5 font-sans">MIT License</span>
            </div>
          </div>
        </div>
      </div>
