...
const useCases = [
  ...
  },
  {
    ...
    description:
      "New business registrations, tax account openings, permit applications in jurisdictions you're expanding into. The agent handles the paperwork.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4">
          ...
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            If a human can complete it in a browser, the agent can do it
            <br className="hidden md:block" />
            faster, cheaper, and with a full audit trail.
          </div>
        </div>
      </div>
